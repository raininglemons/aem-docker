...
prep_term
java -Xmx1024m -Djava.net.useSystemProxies=true -Dhttp.nonProxyHosts="172.28.0.*" -jar cq-quickstart.jar -nofork -nointeractive -r dynamicmedia -r author -port 4502 &
wait_term